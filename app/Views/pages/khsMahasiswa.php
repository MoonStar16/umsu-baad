...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="/khsMahasiswa"><?= $breadcrumb[1]; ?></a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <form autocomplete="off" class="form-horizontal" action="/khsMahasiswa/proses" method="POST">
                            <div class="col-md-2">
                    ...
                    <div class="panel-body col-md-12">
                        ...
                        <?php else : ?>
                            <center>
                                ...
                                <?php if ($filter != null  && $termYear != null  && $entryYear != null) : ?>
                                    <form name="cetak" action="/khsMahasiswa/cetak" method="POST" id="cetak">
